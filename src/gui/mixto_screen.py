...
class MixtoScreen():
    ...
    def __init__(self, panel_principal, app_logic):
        ...
        self.videoImg = util_img.leer_imagen("/home/pi/SmartTV/src/img/Video.png", (self.button_width, self.button_height))
        self.buttonImagen = tk.Button( self.superior_row )
        self.imagenImg = util_img.leer_imagen("/home/pi/SmartTV/src/img/Imagen.png", (self.button_width, self.button_height))
        self.buttonMusica = tk.Button( self.superior_row )
        self.musicaImg = util_img.leer_imagen("/home/pi/SmartTV/src/img/Musica.png", (self.button_width, self.button_height))
