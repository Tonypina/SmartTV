...
class HomeScreen():
    ...
    def __init__(self, panel_principal, app_logic):
        ...
        self.nextflixImg = util_img.leer_imagen("/home/pi/SmartTV/src/img/Netflix.png", (self.button_width, self.button_height))
        self.buttonGoogle = tk.Button( self.superior_row )
        self.googleImg = util_img.leer_imagen("/home/pi/SmartTV/src/img/Google.png", (self.button_width, self.button_height))
        self.buttonYoutube = tk.Button( self.superior_row )
        self.youtubeImg = util_img.leer_imagen("/home/pi/SmartTV/src/img/Youtube.png", (self.button_width, self.button_height))
        self.buttonSpotify = tk.Button( self.inferior_row )
        self.spotifyImg = util_img.leer_imagen("/home/pi/SmartTV/src/img/Spotify.png", (self.button_width, self.button_height))
        self.buttonHBO = tk.Button( self.inferior_row )
        self.HBOImg = util_img.leer_imagen("/home/pi/SmartTV/src/img/HBO.png", (self.button_width, self.button_height))
        self.buttonF1 = tk.Button( self.inferior_row )
        self.F1Img = util_img.leer_imagen("/home/pi/SmartTV/src/img/F1.png", (self.button_width, self.button_height))
